...
#define SERVER_IP "192.168.1.132:8000" 
...
void setup() {
  ...
  WiFi.begin("BaoLong", "lelong0987654321");
}
...
void loop() {
  ...
  // wait for WiFi connection
    ...
    String valueRFID = "";
    valueRFID = ReadRFID(mfrc522);
    if (valueRFID != ""){
      Serial.println("Scan successfully with tag: ");
      Serial.print(valueRFID.substring(1));
      sendRFIDtoBE(valueRFID);
      Serial.println();
      Serial.println("Continue to Scan RFID:..........");
    }
    else{
      Serial.println("Your Tag does not write Data Block");
            Serial.println();
      Serial.println("Continue to Scan RFID:..........");
    }
  }
